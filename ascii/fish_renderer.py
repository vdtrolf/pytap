...
def get_fish_ascii(fish,cellSize):
    ...
    if cellSize == 4 :
		if fish.onHook :
			return [[Fore.BLUE + "\\/x\\",Fore.BLUE + "  __ ",Fore.BLUE + "/\\_/"],[Fore.BLUE + "/x\\/",Fore.BLUE + "  __ ",Fore.BLUE + "\\_/\\",]][fish.angle]
		else:
			return [[Fore.BLUE + "\\/o\\",Fore.BLUE + "  __ ",Fore.BLUE + "/\\_/"],[Fore.BLUE + "/o\\/",Fore.BLUE + "  __ ",Fore.BLUE + "\\_/\\",]][fish.angle]
	else :
    	if fish.onHook :
